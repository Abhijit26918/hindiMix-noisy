"""
XLM-R Baseline Trainer for Hate Speech Detection.

XLM-RoBERTa-base: strong multilingual baseline trained on 100 languages.

Run: python models/baselines/xlmr_trainer.py --noise_level clean
     python models/baselines/xlmr_trainer.py --noise_level medium
"""
...
CHECKPOINT_DIR = "models/baselines/checkpoints/xlmr"
...
def main(args):
    print(f"\n[XLM-R Baseline] noise_level={args.noise_level} | device={DEVICE}")
    ...
    out_path = f"{RESULTS_DIR}/xlmr_{args.noise_level}.json"
